...
private:
    ...
    size_t leaf_count(Node<K, V> *node) const {
        ...
        //left =  leaf_count(node --> left);
        //right = leaf_count(node --> right);
    ...
    size_t width(Node<K, V> *node, size_t level) const {
        // TODO
        //int left =  width(node -> left);
        //int right = width(node -> right);
    ...
    size_t sum_levels(Node<K, V> *node, size_t level) const {
        // TODO
        //int left =  sum_levels(node -> left);
        //int right = sum_levels(node -> right);
    ...
    size_t sum_null_levels(Node<K, V> *node, size_t level) const {
        // TODO
        //int left =  sum_null_levels(node -> left);
        //int right = sum_null_levels(node -> right);
